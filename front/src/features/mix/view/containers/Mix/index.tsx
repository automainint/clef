...
import { DiscsChainCard, MixingDeck, Preloader } from 'shared/components';
...
const Mix: FC<Props> = observer(({ user, ConnectButton, PlayButton, ObserveDNAButton, Disc, onMix }) => {
  const {
    songs,
    hybrid,
    newHybrid,
