...
(async () => {
  try {
    ...
    for (let i = 0; i < count; i++) {
      ...
      await make_song('Minor Silence', 140, -3,
      ...
      await make_song('Pluto Style', 180, 2,
      ...
      await make_song('Hodling Onto You', 140, 3,
      ...
      await make_song('Stranding USDN', 115, 4,
      ...
      await make_song('Funny AMA', 120, 3,
      ...
      await make_song('Bullish Puzzle', 130, 1,
      ...
      await make_song('Tsunami Love', 115, -2,
      ...
      await make_song('SURF Gazing', 120, -3,
      ...
      await make_song('Lambo Jam', 125, -2,
