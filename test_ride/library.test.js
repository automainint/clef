...
describe('library', async function () {
  ...
  it('mint melody', async function () {
    ...
    const name      = await accountDataByKey(`${n}_ML`,     library);
    const notes_00  = await accountDataByKey(`${n}_M00`,    library);
    const notes_01  = await accountDataByKey(`${n}_M01`,    library);
    const notes_02  = await accountDataByKey(`${n}_M02`,    library);
    const notes_03  = await accountDataByKey(`${n}_M03`,    library);
    const notes_04  = await accountDataByKey(`${n}_M04`,    library);
    const notes_05  = await accountDataByKey(`${n}_M05`,    library);
    const notes_06  = await accountDataByKey(`${n}_M06`,    library);
    const notes_07  = await accountDataByKey(`${n}_M07`,    library);
    const notes_08  = await accountDataByKey(`${n}_M08`,    library);
    const notes_09  = await accountDataByKey(`${n}_M09`,    library);
    const notes_10  = await accountDataByKey(`${n}_M10`,    library);
    const notes_11  = await accountDataByKey(`${n}_M11`,    library);
    const notes_12  = await accountDataByKey(`${n}_M12`,    library);
    const notes_13  = await accountDataByKey(`${n}_M13`,    library);
    const notes_14  = await accountDataByKey(`${n}_M14`,    library);
    const notes_15  = await accountDataByKey(`${n}_M15`,    library);

    expect(name.value).to.equal('some melody');
  ...
  it('mint song', async function () {
    ...
    const melody            = await accountDataByKey(`${n}_SM`,   library);
    ...
    const balance           = await assetBalance(assetId, library);
    ...
    expect(melody.value).to.equal('000a');
  ...
  it('mint hybrid', async function () {
    ...
    const lead_rhythm_6     = await accountDataByKey(`${n}_SI56`, library);
    const lead_rhythm_7     = await accountDataByKey(`${n}_SI57`, library);
    const balance           = await assetBalance(hybrid, foo);
    ...
    _check_random_bit(melody.value, _fix('000a'));
  ...
  it('pay for hybrid with usdn', async function () {
    ...
    const tx_mint_hybrid = invokeScript(
      { dApp: library,
        ...
        payment: [ { assetId: usdn, amount: price } ]
      },
      accounts.foo);
